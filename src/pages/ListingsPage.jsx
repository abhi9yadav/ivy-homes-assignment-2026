...
import { getListings, getLocalities } from '../api.js'
import ListingCard from '../components/ListingCard.jsx'
import Pagination from '../components/Pagination.jsx'
import {
  Search, X, LayoutGrid, List, Map, ChevronDown, ArrowUpDown,
  MapPin, RotateCcw, SlidersHorizontal, IndianRupee
} from 'lucide-react'
...
/* ── Price slider config ──────────────── */
const PRICE_MIN   = 2500000      // ₹25 L
const PRICE_MAX   = 50000000     // ₹5 Cr
const PRICE_STEP  = 500000       // ₹5 L steps

const PRICE_PRESETS = [
  { label: 'Any',    min: PRICE_MIN,  max: PRICE_MAX  },
  { label: '< 50 L', min: PRICE_MIN,  max: 5000000    },
  { label: '50L–1Cr',min: 5000000,    max: 10000000   },
  { label: '1–2 Cr', min: 10000000,   max: 20000000   },
  { label: '2–5 Cr', min: 20000000,   max: PRICE_MAX  },
]
        ...
        <div className={styles.sidebarInner}>
          ...
          <div className={styles.filterBlock}>
            ...
            <div className={styles.priceDisplay}>
              ...
              <span className={`${styles.priceVal} ${priceActive ? styles.priceValActive : ''}`}>
                {filters.priceMax >= PRICE_MAX ? '₹5 Cr+' : fmtPriceShort(filters.priceMax)}
              </span>
            </div>
      ...
      <div className={styles.content}>
        ...
        <div className={styles.topBar}>
          <p className={styles.resultCount}>
            {loading ? 'Loading…' : (
              <><strong>{listings.length}</strong> of {total.toLocaleString('en-IN')} properties</>
            )}
          </p>
